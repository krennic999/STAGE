...
DEVICE = "cuda"
MY_CONFIG_PATH="/your-geneval-root/GenEval/mmdetection/configs/mask2former/mask2former_swin-s-p4-w7-224_lsj_8x2_50e_coco.py"
MY_CKPT_PATH="/your-ckpt-root/ckpts/mmdetection"
...
def load_geneval():
    ...
    def load_models():
        ...
        clip_arch = "ViT-L-14"
        pretrained='/your-ckpt-root/ckpts/timm/vit_large_patch14_clip_224.openai/open_clip_pytorch_model.bin'
        clip_model, _, transform = open_clip.create_model_and_transforms(clip_arch, pretrained=pretrained, device=DEVICE)
